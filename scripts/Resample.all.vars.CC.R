...
files <- list.files(Dir,
                    pattern = "Trendy.*CC.pantropical.v13.RDS",
                    full.names = TRUE)
files <- files[grepl("S3",files)]
overwrite = TRUE
...
# scp /home/femeunier/Documents/projects/Congo.vs.Amazon/scripts/Resample.all.vars.CC.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
