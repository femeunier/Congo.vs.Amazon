...
for (csuffix in suffixes){
  ...
  for (cmodel in models){
    ...
    file <- paste0("./data/grid.",cmodel,".ERA5.v12.IFL.RDS")
    ...
    inputs <- climate %>%
      ...
      mutate(xgb.model = paste0(Prefix,csuffix,".",model,".S2")) %>%
...
# scp /home/femeunier/Documents/projects/Congo.vs.Amazon/scripts/post.processing.XGBmodels.R hpc:/data/gent/vo/000/gvo00074/felicien/R/
