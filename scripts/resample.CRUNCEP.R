...
system2("rsync",
        paste("hpc:/data/gent/vo/000/gvo00074/felicien/R/outputs/df.CRU.pantropical.RDS",
              "./outputs/"))
...
data <- readRDS("/home/femeunier/Documents/projects/Congo.vs.Amazon/outputs/df.CRU.pantropical.RDS") %>%
  filter(abs(lat) <= 30,
...
#
# saveRDS(cdata.rspld,
#         "./outputs/monthly.climate.pantropical.CRU_coord.RDS")

cdata.rspld <- readRDS("./outputs/monthly.climate.pantropical.CRU_coord.RDS")
...
saveRDS(data.sum,
        "./outputs/biome.pantropical.CRU_coord.RDS")
